...
# function CPU1_UNDER_LOW_THRESHOLD() { [ $CPU1_TEMPERATURE -lt $CPU_TEMPERATURE_LOW_THRESHOLD ]; }
# function CPU2_OVERHEATING() { [ $CPU2_TEMPERATURE -gt $CPU_TEMPERATURE_THRESHOLD ]; }
# function CPU2_UNDER_LOW_THRESHOLD() { [ $CPU2_TEMPERATURE -lt $CPU_TEMPERATURE_LOW_THRESHOLD ]; }
